...
class FeatureRequest(BaseModel):
    ...
    feature_interaction: Optional[float] = Field(
        None,
        description="Interaction feature (will be computed if not provided)"
    )
...
class BatchPredictionRequest(BaseModel):
    ...
    return_features: bool = Field(
        False,
        description="Whether to return input features in response"
    )
...
class PredictionResponse(BaseModel):
    ...
    features: Optional[Dict[str, float]] = Field(
        None,
        description="Input features (if requested)"
    )
...
class BatchPredictionResponse(BaseModel):
    ...
    num_predictions: int = Field(
        ...,
        description="Number of predictions in batch"
    )
