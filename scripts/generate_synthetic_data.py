...
def generate_synthetic_data(
    ...
    """
    logger.info(f"Generating synthetic data: {num_rows} rows, {num_features} features")
    ...
    df["timestamp"] = pd.date_range(start="2024-01-01", periods=num_rows, freq="1min")
...
def main():
    ...
    parser.add_argument(
        "--rows", type=int, default=100000, help="Number of rows to generate"
    )
    parser.add_argument(
        "--features", type=int, default=4, help="Number of features to generate"
    )
    parser.add_argument(
        "--seed", type=int, default=42, help="Random seed for reproducibility"
    )
    parser.add_argument(
        "--output", type=Path, default=None, help="Output path for the data"
    )
    parser.add_argument(
        "--log-level",
        type=str,
