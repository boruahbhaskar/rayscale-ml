...
class RayTrainingPipeline(BaseTrainingPipeline):
    ...
    def _init_ray(self) -> None:
        ...
        ray.init(
            ...
            logging_level="info" if settings.environment == "development" else "warning",
    ...
    def _apply_transformation(self, dataset: rd.Dataset, transform: Dict[str, Any]) -> rd.Dataset:
    ...
    def create_model(self) -> TabularNNModel:
        ...
        logger.info(
            f"Created model: {model.name} with architecture: {architecture}"
        )
    ...
    def create_trainer(self) -> RayModelTrainer:
        ...
        trainer = RayModelTrainer(
            self.model,
            **training_config.get("trainer_config", {})
        )
    ...
    def train(self) -> Any:
        ...
        result = self.trainer.train(
            data,
            **training_config.get("training_kwargs", {})
        )
